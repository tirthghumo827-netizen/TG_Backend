...
class UjjainOmkareshwarTrip(Base):
    __tablename__ = "ujjain_omkareshwar_trip"
...
class UjjainOmkareshwarTraveller(Base):
    __tablename__ = "ujjain_omkareshwar_travellers"

    id = Column(Integer, primary_key=True, index=True)

    booking_id = Column(
        Integer,
        ForeignKey("ujjain_omkareshwar_trip.id"),
        nullable=False
    )
