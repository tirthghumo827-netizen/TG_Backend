...
def get_price_per_person_chota_pachmarhi_qr(total_people: int , meal_preference : str):
  ...
  if meal_preference == "true":
      ...
      if total_people  == 1:
          ...
          return 965
def get_price_per_person_ujjain_qr(total_people: int , meal_preference : str , payment_status: str):
  amount = 0
  if meal_preference == "true":
      if total_people == 1:
          amount = 5599
...
async def generate_odt_qr(
  ...
  amount = get_price_per_person_ujjain_qr(number_of_people , meal_preference , payment_status) * number_of_people
