...
def send_admin_vr_darshan_email(booking):
    ...
    approve_url = f"https://web-production-5736e.up.railway.app/divya-drishti/approve-booking/{booking.id}"

    decline_url = f"https://web-production-5736e.up.railway.app/divya-drishti/reject-booking/{booking.id}"
