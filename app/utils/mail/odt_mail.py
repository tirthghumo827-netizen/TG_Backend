...
def send_booking_email(
    ...
    # --- Links --- 
    approve_link = (
    f"https://web-production-5736e.up.railway.app{config['approve_route']}?booking_id={booking_id}"
    )

    decline_link = (
        f"https://web-production-5736e.up.railway.app{config['decline_route']}?booking_id={booking_id}"
    )
